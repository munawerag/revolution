    ...
    <section className={`${style.section}`}>
      <div className={style.wrapper}>
        <Heading
          ...
          title2="THE PYRAMID turns on the body’s own natural healing system"
        />
        <div className={style.descWrapper}>
          <p className="fw-300 text-center">
            Eywa is the first and only residential building with a built-in
            pyramid featuring 1,450 semi-precious stones and crystals, weighing
            a total of 14,000 kg. This unique architectural element is designed
            to enhance the health and increase the life expectancy of all those
            residing within. It helps boost focus, enhances cell regeneration
            and dispels conflict.
          </p>
          <p className="fw-300 text-center">
            THE PYRAMID turns on the body’s own natural healing system to
            reverse aging & activate dormant parts of our DNA. It extends life
        ...
        <div className={style.imgContainer}>
          <div className={style.imgWrapper}>
            <Image
              src={"/assets/images/home/pyramid-1.png"}
              className="img-hack"
              height={422}
              width={231}
              alt="pyramid"
          ...
          <div className={style.imgWrapper2}>
            <Image
              src={"/assets/images/home/pyramid-2.png"}
              className="img-hack"
              height={422}
              width={428}
              alt="pyramid"
        ...
        <div className={style.stoneWrapper}>
          <Image
            src={"/assets/images/home/stones.png"}
            height={123}
            width={800}
            alt="stones"
          />
      ...
      <div className={style.locationContainer}>
        <div className="container">
          <h3 className={`text-center fw-300 ${style.heading}`}>
          ...
          <div className={style.locationWrapper}>
            {data?.stone?.map((item: any, index: number) => (
              <div className={`${style.titleWrapper}`} key={index}>
                <div
                  className={`${style.tile} ${style[item?.color]}`}
      ...
      <div className={style.fullImg}>
        <div className={style.imgWrapper}>
          <Image
            alt="pyramid"
            src={"/assets/images/home/pyramid-full.jpg"}
            fill
            className="img-hack"
          />
        </div>
